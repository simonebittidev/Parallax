        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form onSubmit={handleEmailSignIn} className="space-y-6">
            ...
            <div className="text-sm">
              <a href="/reset" className="font-semibold text-indigo-600 hover:text-indigo-800">Forgot password?</a>
            </div>
          ...
          <p className="mt-10 text-center text-sm/6 text-gray-500">
            Not a member?{' '}
            <a href="/signup" className="font-semibold text-indigo-600 hover:text-indigo-800">Sign up</a>
          </p>
        </div>
      </div>
    </>
